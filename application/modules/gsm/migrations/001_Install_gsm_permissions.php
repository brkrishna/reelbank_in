...
class Migration_Install_gsm_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Gsm.Content.View',
			'description' => 'View Gsm Content',
			'status' => 'active',
		),
		array(
			'name' => 'Gsm.Content.Create',
			'description' => 'Create Gsm Content',
			'status' => 'active',
		),
		array(
			'name' => 'Gsm.Content.Edit',
			'description' => 'Edit Gsm Content',
			'status' => 'active',
		),
		array(
			'name' => 'Gsm.Content.Delete',
			'description' => 'Delete Gsm Content',
			'status' => 'active',
		),
    );
