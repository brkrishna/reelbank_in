    ...
    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
        <fieldset>
            ...
            <div class="control-group<?php echo form_error('remarks') ? ' error' : ''; ?>">
                ...
                <div class='controls'>
                    <textarea id='remarks' type='text' name='remarks' rows='8' cols='80' maxlength='4000' value="<?php echo set_value('remarks', isset($items->remarks) ? $items->remarks : ''); ?>"></textarea>
                    <span class='help-inline'><?php echo form_error('remarks'); ?></span>
                </div>
            </div>
        </fieldset>
        <fieldset class='form-actions'>
            <input type='submit' name='save' class='btn btn-primary' value="<?php echo lang('items_action_create'); ?>" />
            <?php echo lang('bf_or'); ?>
